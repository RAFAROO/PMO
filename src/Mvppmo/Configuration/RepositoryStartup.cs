...
using Mvppmo.Domain.Repositories.Interfaces;
using Mvppmo.Infrastructure.Data.Repositories;

namespace Mvppmo.Configuration;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("Mvppmo.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("Mvppmo.Infrastructure.Data.Repositories") &&
